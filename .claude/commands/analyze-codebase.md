...
- Kubernetes files: !`find . \( -name "*k8s*.yaml" -o -name "*k8s*.yml" -o -name "*kubernetes*.yaml" -o -name "*kubernetes*.yml" -o -name "*deployment*.yaml" -o -name "*deployment*.yml" -o -name "*service*.yaml" -o -name "*service*.yml" \) -type f`
