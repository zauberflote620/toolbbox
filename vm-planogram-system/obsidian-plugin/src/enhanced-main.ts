    ...
    <script>
        class PlanogramEditor {
            constructor() {
                ...
                this.zoneColors = {
                    EYE: '#10b981', REACH: '#3b82f6', STRETCH: '#f59e0b', STOOP: '#6b7280'
                };
            ...
            setupEventListeners() {
                ...
                ['fixtureName', 'fixtureZone'].forEach(id => {
            ...
            onMouseMove(e) {
                ...
                if (this.mode === 'select' && this.selectedFixture) {
                    if (this.isDragging) {
                        this.selectedFixture.x = Math.max(0, Math.min(40 - this.selectedFixture.width, x - this.dragOffset.x));
                        this.selectedFixture.y = Math.max(0, Math.min(30 - this.selectedFixture.height, y - this.dragOffset.y));
            ...
            drawFixture(fixture, isSelected) {
                ...
                this.ctx.fillStyle = this.zoneColors[fixture.vmZone] || '#6b7280';
